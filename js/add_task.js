...
async function renderContactsInAssignDropDownMenu() {
  ...
  for (let contact = 0; contact < coworkersToAssignTo.length; contact++) {
    if (contact != loggedInUserIndex && !guestLoggedIn) {
      ...
      /* if (name != 'Guest')  */ assignedContactList.innerHTML +=
        generateAssignContactListForDropDownMenu(name, contact);
    }
  }
}
...
function tabletViewAddMarginTopCatList() {
  if (catListStatus && window.innerWidth >= 768 && window.innerWidth <= 1100) {
    document
      .getElementById("addTaskRightContainer")
...
function checkIdAndRemoveMargin2() {
  if (document.querySelector("#addTaskRightContainer")) {
    document
      .getElementById("addTaskRightContainer")
      .classList.remove("addTaskRightContainerAddMarginTop");
    resetResizePageAndChangeBtnPosition();
  }
}
...
function tabletViewAddMarginTopAssignList() {
  if (
    ...
    document
      .getElementById("addTaskRightContainer")
      .classList.add("addTaskRightContainerAddMarginTop");
    resizePageAndChangeBtnPosition();
  }
  if (
    !assignListStatus ||
...
function resizePageAndChangeBtnPosition() {
  document
    .getElementById("testResponsiv")
    .classList.add("testResponsivNewHeight");
  btnPosition1();
}
...
function resetResizePageAndChangeBtnPosition() {
  document
    .getElementById("testResponsiv")
    .classList.remove("testResponsivNewHeight");
  document
    .getElementById("testResponsiv")
    .classList.remove("testResponsivNewHeight1");
  btnPosition2();
}
...
function btnPosition1() {
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.remove("addTaskBtnOuterContainerNewTopValue2");
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.remove("addTaskBtnOuterContainerNewTopValue");
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.add("addTaskBtnOuterContainerNewTopValue1");
}
...
function btnPosition2() {
  ...
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.remove("addTaskBtnOuterContainerNewTopValue1");
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.add("addTaskBtnOuterContainerNewTopValue");
}
...
function btnPosition3() {
  ...
  document
    .getElementById("addTaskBtnOuterContainer")
    .classList.add("addTaskBtnOuterContainerNewTopValue2");
}
...
function addTaskRightContainerNewHeight1() {
  ...
  document
    .getElementById("addTaskRightContainer")
    .classList.add("addTaskRightContainerAddMarginTop1");
}
...
function testResponsivNewHeight1() {
  ...
  document
    .getElementById("testResponsiv")
    .classList.add("testResponsivNewHeight1");
}
...
function tabletViewAddTaskResize() {
  ...
  if (
    (!assignListStatus && !catListStatus) ||
    window.innerWidth < 768 ||
    window.innerWidth > 1100
  ) {
    if (document.querySelector("#addTaskRightContainer")) {
      document
        .getElementById("addTaskRightContainer")
        .classList.remove("addTaskRightContainerAddMarginTop1");
