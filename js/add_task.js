...
async function renderAddTask() {
	...
	<div class="addTaskBtnOuterContainer">
		<div class="addTaskBtnInnerContainer">
			...
			<button type='submit' class="addTaskCreate" onclick="checkInputs()">
	...
	<form id='AddTaskForm' onsubmit = 'return false;'>
		<div class="addTaskAddTitleContainer">
			...
			<div class="addTaskAddDescriptenBox">
				...
				<!-- <textarea form="formDesc"  placeholder="Enter Descripten" id="addTaskDescripten"  required minlength="5" >

				</textarea> -->
				<label for="message">Message:</label><br>
  				<textarea id="message" name="message" required pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$"></textarea>
  				<br><br>
...
const textarea = document.getElementById('addTaskDescripten');
...
/**
 * If the joinTaskArray exists in localStorage, then get the joinTaskArray from localStorage and parse
...
/**
 * If the localStorage item 'joinTaskArray' exists, return it.
 * @returns The value of the key 'joinTaskArray' in localStorage.
 */
...
/**
 * If the category list and new category input are not active, then remove the class listD-none from
 * the category list and add the class addMarginTop to the add task assigned box. Otherwise, add the
 * class listD-none to the category list and remove the class addMarginTop from the add task assigned
 * box.
 */
...
/**
 * If the category list is not active and the new category input is not active, then return true.
...
/**
 * It renders the category list in the dropdown menu of the add task modal.
 */
